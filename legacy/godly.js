...
name:'Godly',
author:'trugam3rr',
desc:'dumb mod that makes game ez',
engineVersion:1,
manifest:0,
func:function()
{
	...
	*/
	...
	new G.Res({
		...
		tick:function(me,tick)
		{
			...
			if (me.amount>0)
			{
				...
				var deathUnhappinessMult=0.5;
				if (G.has('fear of death')) deathUnhappinessMult*=1;
				...
				if (G.checkPolicy('disable aging')=='off')
				{
					...
					var sickHealing=0.25;
					if (G.checkPolicy('flower rituals')=='on') sickHealing*=2;
					var changed=0;
	...
	new G.Res({
		...
		icon:[4,7],
    startWith:10000,
		turnToByContext:{'eating':{'health':0.5,'happiness':0.25},'decay':{'spoiled food':1}},
		partOf:'food',
		category:'food',
	});
	new G.Res({
